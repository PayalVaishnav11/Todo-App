...
function App() {
    ...
    const howMuchCompleted=(count)=> {
         console.log("PassedCount:",count)
         todos.map((eachTodo)=> eachTodo.isCompleted ? count++ : count)
          console.log("NowCount:",count)
          return count
    }
  ...
  return (
    < TodoContextProvider value={{todos,addTodo,deleteTodo,toggleCompleted,editTodo,howMuchCompleted}}>
